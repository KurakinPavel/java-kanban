...
DROP TABLE IF EXISTS PUBLIC.TASK_PERFORMERS;
...
(
    ...
    PERFORMER_ID INTEGER REFERENCES PUBLIC.USERS (USER_ID) ON DELETE CASCADE,
    CONSTRAINT uq_task_performer UNIQUE (TASK_ID, PERFORMER_ID)
);
